...
## 1. The Pi extension runs the CLI [#1-the-pi-extension-runs-the-cli]
...
## 2. The extension wakes the plugin [#2-the-extension-wakes-the-plugin]
...
## 5. Stale rows disappear [#5-stale-rows-disappear]
...
## Normal update path [#normal-update-path]
