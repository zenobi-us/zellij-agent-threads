# Generic harness setup (/harness-setup)



# Generic harness setup [#generic-harness-setup]
...
## `agent-threads upsert` [#agent-threads-upsert]
...
### Agent Report v2 fields [#agent-report-v2-fields]
...
## `agent-threads delete` [#agent-threads-delete]
...
## `agent-threads snapshot` [#agent-threads-snapshot]
...
## Limits of hook-only setup [#limits-of-hook-only-setup]
