---
title: Quickstart
description: Install the released CLI, add the Zellij plugin pane, and see Pi Agents in Zellij.
status: draft
category: tutorial
tags:
  - quickstart
...
## 2. Install the plugin and Pi extension
...
## 4. Add the plugin pane to a layout
